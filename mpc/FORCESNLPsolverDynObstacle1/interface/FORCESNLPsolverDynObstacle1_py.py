...
a Python wrapper for a fast solver generated by FORCESPRO v6.2.0
   ...
   OUTPUT = FORCESNLPsolverDynObstacle1_py.FORCESNLPsolverDynObstacle1_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolverDynObstacle1_py.FORCESNLPsolverDynObstacle1_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolverDynObstacle1_py.FORCESNLPsolverDynObstacle1_solve(PARAMS) returns 
...
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolverDynObstacle1/lib/FORCESNLPsolverDynObstacle1_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolverDynObstacle1_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolverDynObstacle1/lib/libFORCESNLPsolverDynObstacle1_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolverDynObstacle1_solve')

internal_mem = getattr(_lib,'FORCESNLPsolverDynObstacle1_internal_mem')

class FORCESNLPsolverDynObstacle1_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolverDynObstacle1_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolverDynObstacle1_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
}

class FORCESNLPsolverDynObstacle1_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolverDynObstacle1_outputs = {'x1' : np.array([]),
'x2' : np.array([]),
'x3' : np.array([]),
'x4' : np.array([]),
'x5' : np.array([]),
...
class FORCESNLPsolverDynObstacle1_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class FORCESNLPsolverDynObstacle1_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolverDynObstacle1_params_ctypes), ctypes.POINTER(FORCESNLPsolverDynObstacle1_outputs_ctypes), ctypes.POINTER(FORCESNLPsolverDynObstacle1_info), ctypes.POINTER(FORCESNLPsolverDynObstacle1_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(FORCESNLPsolverDynObstacle1_mem)

def FORCESNLPsolverDynObstacle1_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.2.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = FORCESNLPsolverDynObstacle1_params_ctypes()
    for par in params_arg:
        ...
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=FORCESNLPsolverDynObstacle1_params_types[par], requirements='F')
    ...
    outputs_py = FORCESNLPsolverDynObstacle1_outputs_ctypes()
    info_py = FORCESNLPsolverDynObstacle1_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolverDynObstacle1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.FORCESNLPsolverDynObstacle1_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolverDynObstacle1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.FORCESNLPsolverDynObstacle1_adtool2forces)
            else:
                exitflag = _lib.FORCESNLPsolverDynObstacle1_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.FORCESNLPsolverDynObstacle1_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in FORCESNLPsolverDynObstacle1_outputs:
        FORCESNLPsolverDynObstacle1_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return FORCESNLPsolverDynObstacle1_outputs,int(exitflag),info_py

solve = FORCESNLPsolverDynObstacle1_solve
