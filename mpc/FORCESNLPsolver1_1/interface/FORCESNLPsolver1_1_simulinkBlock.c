...
#define S_FUNCTION_NAME FORCESNLPsolver1_1_simulinkBlock
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call solver */
    solver_exitflag = FORCESNLPsolver1_1_solve(&params, &output, &info, mem, fp , pt2function_FORCESNLPsolver1_1);
