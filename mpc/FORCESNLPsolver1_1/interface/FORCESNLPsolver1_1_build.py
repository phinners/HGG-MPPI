...
sourcefile = os.path.join(os.getcwd(),"FORCESNLPsolver1_1","src","FORCESNLPsolver1_1"+".c")

# determine lib file
if sys.platform.startswith('win'):
	libfile = os.path.join(os.getcwd(),"FORCESNLPsolver1_1","lib","FORCESNLPsolver1_1"+".lib")
else:
	libfile = os.path.join(os.getcwd(),"FORCESNLPsolver1_1","lib","FORCESNLPsolver1_1"+".so")	

# create lib dir if it does not exist yet
if not os.path.exists(os.path.join(os.getcwd(),"FORCESNLPsolver1_1","lib")):
	os.makedirs(os.path.join(os.getcwd(),"FORCESNLPsolver1_1","lib"))
								

				
# compile into object file
objdir = os.path.join(os.getcwd(),"FORCESNLPsolver1_1","obj")
