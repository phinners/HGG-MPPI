...
typedef FORCESNLPsolver1_1_float solver_float;
...
void copyCArrayToM_FORCESNLPsolver1_1(FORCESNLPsolver1_1_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolver1_1(FORCESNLPsolver1_1_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolver1_1(double *src, FORCESNLPsolver1_1_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
...
void copyMValueToC_FORCESNLPsolver1_1(double * src, FORCESNLPsolver1_1_float * dest)
{
	*dest = (FORCESNLPsolver1_1_float) *src;
}
             ...
             solver_int* dimp, solver_int* diml, solver_int* dimu, solver_int* dimhl, solver_int* dimhu)
{
    ...
    const solver_int dimpArr[NSTAGES] = {18, 18, 18, 18, 18, 18, 18, 18};
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolver1_1(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolver1_1(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolver1_1(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolver1_1(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
