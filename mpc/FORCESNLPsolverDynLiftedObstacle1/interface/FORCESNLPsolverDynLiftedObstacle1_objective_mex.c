...
typedef FORCESNLPsolverDynLiftedObstacle1_float solver_float;
...
void copyCArrayToM_FORCESNLPsolverDynLiftedObstacle1(FORCESNLPsolverDynLiftedObstacle1_float *src, double *dest, solver_int32_default dim) 
{
...
void copyCValueToM_FORCESNLPsolverDynLiftedObstacle1(FORCESNLPsolverDynLiftedObstacle1_float* src, double* dest)
{
    *dest = (double)*src;
}

void copyMArrayToC_FORCESNLPsolverDynLiftedObstacle1(double *src, FORCESNLPsolverDynLiftedObstacle1_float *dest, solver_int32_default dim) 
{
    solver_int32_default i;
    for( i = 0; i < dim; i++ ) 
    {
...
void copyMValueToC_FORCESNLPsolverDynLiftedObstacle1(double * src, FORCESNLPsolverDynLiftedObstacle1_float * dest)
{
	*dest = (FORCESNLPsolverDynLiftedObstacle1_float) *src;
}
             ...
             solver_int* dimp, solver_int* diml, solver_int* dimu, solver_int* dimhl, solver_int* dimhu)
{
    ...
    const solver_int dimpArr[NSTAGES] = {24, 24, 24, 24, 24, 24, 24, 24};
    const solver_int dimlArr[NSTAGES] = {10, 10, 10, 10, 10, 10, 10, 10};
    const solver_int dimuArr[NSTAGES] = {9, 9, 9, 9, 9, 9, 9, 9};
...
void mexFunction( solver_int nlhs, mxArray *plhs[], solver_int nrhs, const mxArray *prhs[] )  
{
    ...
    arr = prhs[0];
    copyMArrayToC_FORCESNLPsolverDynLiftedObstacle1(mxGetPr(arr), z, nvar);
    if (nrhs > 1)
	{
        arr = prhs[1];
        if ( !mxIsEmpty(arr) )
        {
            copyMArrayToC_FORCESNLPsolverDynLiftedObstacle1(mxGetPr(arr), p, dimp);
        }
	}   
	...
	copyCArrayToM_FORCESNLPsolverDynLiftedObstacle1(obj, mxGetPr(obj_mex), 1);
	copyCArrayToM_FORCESNLPsolverDynLiftedObstacle1(jacobj, mxGetPr(gradobj_mex), nvar);
	plhs[0] = obj_mex;
	plhs[1] = gradobj_mex;
