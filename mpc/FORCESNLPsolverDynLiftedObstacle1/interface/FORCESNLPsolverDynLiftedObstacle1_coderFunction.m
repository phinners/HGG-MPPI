...
% 
% [OUTPUTS] = FORCESNLPsolverDynLiftedObstacle1(INPUTS) solves an optimization problem where:
% Inputs:
...
function [x1, x2, x3, x4, x5, x6, x7, x8] = FORCESNLPsolverDynLiftedObstacle1(xinit, x0, all_parameters)
    
    [output, ~, ~] = FORCESNLPsolverDynLiftedObstacle1Buildable.forcesCall(xinit, x0, all_parameters);
    x1 = output.x1;
    x2 = output.x2;
    x3 = output.x3;
    x4 = output.x4;
