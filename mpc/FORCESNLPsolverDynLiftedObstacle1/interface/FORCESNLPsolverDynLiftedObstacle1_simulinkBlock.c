...
#define S_FUNCTION_NAME FORCESNLPsolverDynLiftedObstacle1_simulinkBlock
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 192, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call solver */
    solver_exitflag = FORCESNLPsolverDynLiftedObstacle1_solve(&params, &output, &info, mem, fp , pt2function_FORCESNLPsolverDynLiftedObstacle1);
