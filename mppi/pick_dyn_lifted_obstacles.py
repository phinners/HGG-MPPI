...
def get_parameters(args):
    ...
    link_dimensions = {
        ...
        'panda_link7': torch.tensor([0.0, 0.0, 0.145], dtype=dtype_kinematics)  # 0.245
    ...
    def state_cost(x, goal, obstacles):
        ...
        dist1EEF = torch.abs(link8_pos - torch.tensor(obstacles[0:3], device=device))
