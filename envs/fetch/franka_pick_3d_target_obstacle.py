...
class FrankaFetchPick3DTargetObstacle(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=20):
        ...
        self.stat_obstacles = [[1.5, 0.60, 0.555, 0.25, 0.03, 0.15]]
        self.dyn_obstacles = []
    ...
    def _get_obs(self):
        ...
        return {
            ...
            'real_obstacle_info': stat_obstacles,
            'object_dis': obj_dist
        }
    ...
    def _sample_goal(self):
        ...
        # goal[0] = 1.42839046  # -self.target_range_x  # TODO For Reproduction Purpose
        # goal[1] = 0.27043946  # self.target_range_y  # TODO For Reproduction Purpose
        # goal[2] = 0.7166725  # self.target_range_z  # TODO For Reproduction Purpose
