...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs', 'assets', 'fetch', 'franka_pick_dyn_lifted_obstacles.xml')
...
class FrankaFetchPickDynLiftedObstaclesEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    ...
    def step(self, action):
        ...
        return super(FrankaFetchPickDynLiftedObstaclesEnv, self).step(action)
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FrankaFetchPickDynLiftedObstaclesEnv, self).render(mode, width, height)
