...
MODEL_XML_PATH = os.path.join(os.getcwd(), 'envs_real', 'assets', 'franka', 'franka_pick_dyn_lifted_obstacles.xml')
...
class FrankaPickDynLiftedObstaclesEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse', n_substeps=20):
        ...
        self.further = False
        self.gripper_extra_height = [0, 0, 0.0]
        ...
        self.target_x = np.array([-0.07, 0, 0.07])
    ...
    def step(self, action):
        ...
        return super(FrankaPickDynLiftedObstaclesEnv, self).step(action)
    ...
    def _sample_goal(self):
        ...
        goal[0] += self.np_random.choice(self.target_x)
        goal[2] += 0.07
    ...
    def _env_setup(self, initial_qpos):
        ...
        if self.block_object_in_gripper:
            ...
            # object_qpos2[2] = 0.4 + 0.00  # lift object a bit
    ...
    def render(self, mode='human', width=1080, height=1080):
        return super(FrankaPickDynLiftedObstaclesEnv, self).render(mode, width, height)
